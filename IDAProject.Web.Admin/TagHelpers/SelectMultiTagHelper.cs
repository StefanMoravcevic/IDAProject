...
{
    [HtmlTargetElement("tms-select-multi", TagStructure = TagStructure.NormalOrSelfClosing)]
    public class SelectMultiTagHelper : BaseTagHelper
    {
        private string _id;
        ...
        public SelectMultiTagHelper(IHtmlHelper htmlHelper) : base(htmlHelper)
        {
