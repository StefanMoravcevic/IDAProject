...
;// CONCATENATED MODULE: ./src/IDeclarationFactory.ts
// Licensed to the .NET Foundation under one or more agreements.
// The .NET Foundation licenses this file to you under the MIT license.
...
(function (HttpTransportType) {
    ...
    /** Specifies the WebSockets DeclarationFactory. */
    HttpTransportType[HttpTransportType["WebSockets"] = 1] = "WebSockets";
    /** Specifies the Server-Sent Events DeclarationFactory. */
    HttpTransportType[HttpTransportType["ServerSentEvents"] = 2] = "ServerSentEvents";
    /** Specifies the Long Polling DeclarationFactory. */
...
;// CONCATENATED MODULE: ./src/LongPollingDeclarationFactory.ts
// Licensed to the .NET Foundation under one or more agreements.
// The .NET Foundation licenses this file to you under the MIT license.
...
;// CONCATENATED MODULE: ./src/ServerSentEventsDeclarationFactory.ts
// Licensed to the .NET Foundation under one or more agreements.
// The .NET Foundation licenses this file to you under the MIT license.
...
;// CONCATENATED MODULE: ./src/WebSocketDeclarationFactory.ts
// Licensed to the .NET Foundation under one or more agreements.
// The .NET Foundation licenses this file to you under the MIT license.
...
class HttpConnection {
    ...
    async _stopInternal(error) {
        ...
        if (this.transport) {
            try {
                await this.DeclarationFactory.stop();
            }
            catch (e) {
                this._logger.log(LogLevel.Error, `HttpConnection.DeclarationFactory.stop() threw error '${e}'.`);
    ...
    _startTransport(url, transferFormat) {
        this.DeclarationFactory.onreceive = this.onreceive;
        this.DeclarationFactory.onclose = (e) => this._stopConnection(e);
        return this.DeclarationFactory.connect(url, transferFormat);
    }
...
class TransportSendQueue {
    ...
    async _sendLoop() {
        while (true) {
            ...
            try {
                await this._DeclarationFactory.send(data);
