...
{
    public partial class VehicleOptionalCost
    {
        ...
        public bool IsPayedByDriver { get; set; }
        public string? StatementNumber { get; set; }
        public DateTime? PaymentDate { get; set; }
        public int? PayedByPartnerId { get; set; }
        public int? PayedByDriverId { get; set; }
        public bool AllowManualAmountCorrection { get; set; }
        public bool IsDeleted { get; set; }
        public DateTime? DeletedDate { get; set; }
        public int? DeletedBy { get; set; }

        public virtual AccountingPeriodType AccountingPeriod { get; set; } = null!;
