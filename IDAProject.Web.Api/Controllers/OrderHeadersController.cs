...
namespace IDAProject.Web.Api.Controllers
{
    ...
    public class OrderHeadersController : ControllerBase
    {
        ...
        private string REMOVED_SECRET = "clktr_3922ce9831919ef53cf98a4bab349007";
        private string REMOVED_SECRET = "YynLpmqLhWD94NfyM5IoxJjwWwdX17hW";
        ...
        {
            var token = await _uhuraAuthService.GetTokenAsync(REMOVED_SECRET, REMOVED_SECRET);
